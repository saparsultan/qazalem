...
export default class NewsService {
  ...
  static getOneOriginCountry(id, lang) {
  ...
  static getNewsWorld({
    ...
    return $api.get(
        `news/world/filter/preview?lang=${lang}&subcategory=${subcategory}&published_date_start=${published_date_start}&published_date_end=${published_date_end}&search=${search}&page=${page}&page_size=${page_size}`,
    );
  }

  static getOneNewsWorld(id, lang) {
  ...
  static getOneInterview(id, lang) {
